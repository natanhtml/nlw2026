    ...
    <div className="min-h-screen bg-bg-page">
      <div className="max-w-[1440px] mx-auto px-10 py-20">
        <div className="flex flex-col items-center gap-8">
          ...
          {/* Code Editor */}
          <div className="w-full max-w-[780px] rounded-lg border border-border-primary overflow-hidden">
            {/* Window Header */}
            <div className="h-10 px-4 flex items-center gap-2 border-b border-border-primary bg-bg-input">
            ...
            {/* Code Area */}
            <div className="flex bg-bg-input min-h-[360px]">
              {/* Line Numbers */}
              <div className="w-12 pt-4 pr-3 pb-4 pl-4 text-right border-r border-border-primary bg-bg-input">
                {displayLines.map((_, i) => (
                  <span
                    key={`line-${i}`}
                    className="block font-mono text-xs text-text-tertiary leading-6"
                  >
                    {i + 1}
                  </span>
                ))}
              ...
              <textarea
                ...
                className="flex-1 p-4 bg-bg-input text-text-primary font-mono text-sm leading-6 resize-none focus:outline-none"
                placeholder="// paste your code here..."
                rows={Math.max(displayLines.length, 10)}
              />
            </div>
          </div>
